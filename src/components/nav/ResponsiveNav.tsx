...
function MobileMenu({
  ...
  return (
    <motion.div
      ...
      className="lg:hidden fixed top-24 left-0 right-0 bg-white border-b-2 border-gray-200 z-40 overflow-hidden flex flex-col p-6 space-y-4"
    >
      <div className="pt-4 space-y-[50px] pl-[25px] pb-[90px]">
